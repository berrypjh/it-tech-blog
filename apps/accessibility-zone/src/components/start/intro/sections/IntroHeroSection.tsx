import { AccessibilityHeroIllustration } from '../components/AccessibilityHeroIllustration';
...
export const IntroHeroSection = ({ content }: { content: IntroContent['hero'] }) => {
  return (
    <section
      aria-labelledby="intro-hero-heading"
    ...
    >
      <div className="grid grid-cols-1 items-center gap-xl lg:grid-cols-[1fr_1.05fr] lg:gap-2xl">
        ...
        <div className="order-first lg:order-none">
          <AccessibilityHeroIllustration
            badges={content.badges}
            browser={content.browser}
            illustrationLabel={content.illustrationLabel}
          />
        </div>
      </div>
    </section>
