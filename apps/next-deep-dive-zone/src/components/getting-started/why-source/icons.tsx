...
export {
  ...
  Hammer as BuildIcon,
  MonitorSmartphone as ClientIcon,
  Code2 as CodeIcon,
  ...
  Quote as QuoteIcon,
  Inbox as RequestIcon,
  FolderTree as RouteTreeIcon,
  ServerCog as ServerRenderIcon,
  Sparkles as SparkIcon,
  Split as SplitIcon,
  Send as TransportIcon,
} from 'lucide-react';
