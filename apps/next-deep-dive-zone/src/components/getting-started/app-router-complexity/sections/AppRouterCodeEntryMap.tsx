  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="text-xsm leading-relaxed text-[var(--term-fg)] break-keep">{entry.reads}</p>
      </div>
...
export const AppRouterCodeEntryMap = ({ content }: Props) => {
  return (
