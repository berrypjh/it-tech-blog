...
type Props = { content: UseReducerSharedContent['reducerFlow'] };
...
export const ReducerUpdateFlow = ({ content }: Props) => (
  <section
    aria-labelledby="heading-reducer-flow"
    className={cn(
        ...
        return (
          <li key={step.number} className="relative">
            ...
            >
              ...
              <code
                className={cn(
                  'font-mono text-[11px] sm:text-xsm font-bold leading-tight break-all',
                  toneText[step.tone],
                )}
              >
                {step.title}
