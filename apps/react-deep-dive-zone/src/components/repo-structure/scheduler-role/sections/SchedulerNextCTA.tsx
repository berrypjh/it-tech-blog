...
import { LayerCubeIllustration } from '../components/LayerCubeIllustration';
import type { SchedulerContent } from '../content';
import { ArrowRightIcon, RotateIcon } from '../icons';

type Props = { content: SchedulerContent['nextStep'] };
  ...
  return (
    <section aria-labelledby="heading-next" className="space-y-md">
      ...
      >
        <span
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_30%,rgba(45,212,191,0.22),transparent_55%),radial-gradient(circle_at_85%_75%,rgba(34,211,238,0.20),transparent_55%)]"
        />

        <div className="relative grid grid-cols-1 lg:grid-cols-[auto_minmax(0,1fr)_auto] gap-md sm:gap-lg items-center">
          <div className="flex justify-center lg:justify-start">
            <LayerCubeIllustration className="h-24 w-28 sm:h-28 sm:w-32" />
          </div>
          ...
          <div className="flex flex-col gap-2 w-full lg:w-auto">
            <Link
              ...
              className={cn(
                ...
                'bg-teal-400 text-slate-950 text-xsm font-bold',
                'transition-colors hover:bg-teal-300',
                'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-200 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900',
              )}
            >
              {content.primaryCta}
              <ArrowRightIcon
