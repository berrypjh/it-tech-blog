...
type Props = { content: ReconcilerEntryContent['nextStep'] };
  ...
  return (
    <section aria-labelledby="heading-next" className="space-y-md">
      ...
      >
        <span
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_30%,rgba(139,92,246,0.22),transparent_55%),radial-gradient(circle_at_85%_75%,rgba(34,211,238,0.18),transparent_55%)]"
        />
          ...
          <div className="flex flex-col gap-2 w-full lg:w-auto">
            <Link
              ...
              className={cn(
                ...
                'bg-cyan-400 text-slate-950 text-xsm font-bold',
                'transition-colors hover:bg-cyan-300',
                'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-200 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900',
              )}
            >
              {content.primaryCta}
              <ArrowRightIcon
