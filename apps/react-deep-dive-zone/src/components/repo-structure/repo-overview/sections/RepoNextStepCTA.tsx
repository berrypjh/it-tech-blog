...
type Props = { content: RepoOverviewContent['nextStep'] };

export const RepoNextStepCTA = ({ content }: Props) => {
  return (
    <section aria-labelledby="heading-next" className="space-y-md">
      ...
      >
        ...
        <span
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(56,189,248,0.18),transparent_60%),radial-gradient(circle_at_85%_75%,rgba(16,185,129,0.18),transparent_55%)]"
        />
