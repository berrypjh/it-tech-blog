...
type Props = { content: SurroundingContent['nextStep'] };

export const SurroundingDirectoriesNextCTA = ({ content }: Props) => {
  return (
    <section aria-labelledby="heading-next" className="space-y-md">
      ...
      >
        <span
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_30%,rgba(16,185,129,0.20),transparent_55%),radial-gradient(circle_at_85%_75%,rgba(56,189,248,0.20),transparent_55%)]"
        />
