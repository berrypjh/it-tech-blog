...
type Props = { content: EnqueueConcurrentHookUpdateContent['quiz'] };
        ...
        <div className="relative lg:pl-lg lg:border-l border-dashed border-[var(--term-border)] flex flex-col gap-sm">
          ...
          >
            ...
            <div className="flex flex-col gap-1.5 min-w-0">
              ...
              <code
                className={cn(
                  'inline-flex w-fit items-center rounded-md border px-2.5 py-1 font-mono text-xsm font-bold',
                  'border-slate-800 bg-slate-950 text-amber-200',
                )}
              >
                {content.answerBody}
              </code>
