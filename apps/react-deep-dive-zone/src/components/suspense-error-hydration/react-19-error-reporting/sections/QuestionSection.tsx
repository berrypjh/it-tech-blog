...
const conceptTone: Record<ConceptCard['icon'], string> = {
  map: 'text-blue-600 bg-blue-100 border-blue-200 dark:text-blue-300 dark:bg-blue-950/60 dark:border-blue-800/60',
  refresh:
        ...
        {content.concepts.map((c) => {
          ...
          return (
            <li
              key={c.label}
              className={cn(
                'flex items-start gap-2 rounded-xl border bg-slate-50/50 p-2.5',
