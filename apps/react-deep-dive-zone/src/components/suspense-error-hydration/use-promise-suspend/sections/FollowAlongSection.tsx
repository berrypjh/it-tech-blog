...
type Props = { content: UsePromiseSuspendContent['followAlong'] };
        ...
        <li key={item.title}>
          ...
          >
            <header className="flex items-start gap-2">
              ...
              <span className="text-xsm font-mono font-bold uppercase tracking-wider text-blue-700 dark:text-blue-300">
