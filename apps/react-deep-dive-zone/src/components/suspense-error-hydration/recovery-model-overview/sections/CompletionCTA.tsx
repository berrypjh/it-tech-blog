...
type Props = { content: RecoveryModelOverviewContent['cta'] };
...
export const CompletionCTA = ({ content }: Props) => (
  <section
    aria-labelledby="completion-heading"
    className={cn(
      'relative overflow-hidden rounded-3xl border-2 p-md sm:p-lg lg:p-xl',
      'border-blue-700/60 bg-gradient-to-br from-blue-950 via-blue-900 to-emerald-950',
  ...
  >
    ...
    <div className="relative grid grid-cols-1 gap-md lg:gap-lg lg:grid-cols-[auto_minmax(0,1fr)_minmax(0,300px)] items-center">
      {/* trophy */}
      <div className="flex justify-center lg:justify-start">
        <span
          ...
          className={cn(
            ...
            'border-2 border-emerald-300/60 bg-white/10 backdrop-blur-sm shadow-[0_4px_12px_rgba(16,185,129,0.3)]',
          )}
        >
          <TrophyIcon className="h-8 w-8 sm:h-10 sm:w-10 text-emerald-200" />
        </span>
      </div>

      {/* center */}
      <div className="flex flex-col gap-2 min-w-0">
        <span className="text-[10px] sm:text-xsm font-mono font-bold uppercase tracking-wider text-emerald-300">
          Completion
        </span>
        <h2
      ...
      <div className="flex flex-col gap-2 min-w-0">
        <Link
          ...
          className={cn(
            'group inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-3 w-full',
