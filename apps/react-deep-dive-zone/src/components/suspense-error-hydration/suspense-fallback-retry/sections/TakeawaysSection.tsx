...
import { RefreshCcwIcon, ShieldCheckIcon, SparklesIcon } from '../icons';

import { SectionHeader } from './_SectionHeader';

type Props = { content: SuspenseFallbackRetryContent['takeaways'] };
...
const cardIcons = [ShieldCheckIcon, SparklesIcon, RefreshCcwIcon];
