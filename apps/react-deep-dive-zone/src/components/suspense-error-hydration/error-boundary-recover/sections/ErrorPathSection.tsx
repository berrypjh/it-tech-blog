...
import { ArrowRight, Play, Radar, ServerCrash, TriangleAlert, Zap } from 'lucide-react';
...
type Props = { content: ErrorBoundaryRecoverContent['errorPath'] };

const stepIcons = [Play, Zap, ServerCrash, TriangleAlert, Radar];

export const ErrorPathSection = ({ content }: Props) => (
  <section aria-labelledby="errorpath-heading" className="flex flex-col gap-md">
    <SectionHeader id="errorpath-heading" number={content.number} title={content.title} />
