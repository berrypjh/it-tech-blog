...
import type { QuizCard, ReactElementTypeMeaningContent } from '../content';
import { CheckCircleIcon, HelpCircleIcon } from '../icons';

type Props = { content: ReactElementTypeMeaningContent['quiz'] };

export const TypeQuickQuiz = ({ content }: Props) => (
...
const QuizCardView = ({
  ...
  return (
    ...
    >
      ...
      {card.questionCode && <CodePreviewPanel code={card.questionCode} language="JSX" />}
