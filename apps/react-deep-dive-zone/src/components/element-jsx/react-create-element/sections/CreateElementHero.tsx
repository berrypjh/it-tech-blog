...
export const CreateElementHero = ({ content }: Props) => (
  <section aria-labelledby="hero-heading" className="relative">
    ...
    <div className="mt-lg grid grid-cols-1 lg:grid-cols-[minmax(0,_0.9fr)_minmax(0,_1.1fr)] gap-xl lg:gap-2xl items-start">
      {/* Left text column */}
      <div className="flex flex-col gap-md min-w-0">
        ...
        >
          ...
          <span className="block">
            <span className="font-mono bg-gradient-to-r from-violet-600 via-sky-500 to-teal-500 bg-clip-text text-transparent dark:from-violet-300 dark:via-sky-300 dark:to-teal-300">
              {content.title.line2}
            </span>
          </span>
