...
import { ElementObjectHeroDiagram } from '../components/ElementObjectHeroDiagram';
...
export const ElementObjectHero = ({ content }: Props) => (
  ...
  >
    ...
    <HeroVisualColumn id="hero-element-object">
      <ElementObjectHeroDiagram content={content} />
    </HeroVisualColumn>
  </HeroSection>
);
