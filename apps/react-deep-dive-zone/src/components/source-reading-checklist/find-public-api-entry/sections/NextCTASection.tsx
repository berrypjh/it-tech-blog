...
import { ArrowRightIcon, BoxesIcon } from '../icons';

type Props = { content: FindPublicApiEntryContent['nextCta'] };
    ...
    <section aria-labelledby="heading-next" className="space-y-md">
      <Link
        ...
        className={cn(
          ...
          'border-blue-200 bg-gradient-to-br from-blue-50/80 via-white to-cyan-50/40',
