...
import { ApiEntryHeroDiagram } from '../components/ApiEntryHeroDiagram';
...
export const HeroSection = ({ content }: Props) => (
  <HeroShell
    promptCommand="cat"
    promptPath="source-reading-checklist/find-public-api-entry.md"
    promptSuffix={
  ...
  >
    ...
    <HeroVisualColumn id="hero-find-public-api-entry">
      <ApiEntryHeroDiagram content={content} />
    </HeroVisualColumn>
  </HeroShell>
);
