...
type Props = { content: StartWithQuestionContent['fileFirstFails'] };

export const FileFirstFailsSection = ({ content }: Props) => {
  return (
    <section
      id="section-file-first-fails"
      aria-labelledby="heading-file-first-fails"
    ...
    >
      ...
      <aside
        className={cn(
          'relative overflow-hidden rounded-xl border-2 p-md sm:p-lg',
