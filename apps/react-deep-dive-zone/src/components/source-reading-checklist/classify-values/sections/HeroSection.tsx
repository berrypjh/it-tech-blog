...
import { ArrowRightIcon, BoxesIcon, ListTreeIcon, RepeatIcon, TagsIcon } from '../icons';
...
export const HeroSection = ({ content }: Props) => {
  return (
    <section aria-labelledby="hero-heading" className="relative">
      <TerminalPrompt
        command="cat"
        path="source-reading-checklist/classify-values.md"
        suffix={
      ...
      <div className="mt-md grid grid-cols-1 gap-lg lg:gap-xl lg:grid-cols-[minmax(0,_40fr)_minmax(0,_60fr)] items-stretch">
        ...
        {/* RIGHT — Visual: field-only vs role-classified */}
        <div
          className={cn(
