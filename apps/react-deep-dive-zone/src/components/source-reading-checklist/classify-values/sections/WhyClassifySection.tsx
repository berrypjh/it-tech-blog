...
type Props = { content: ValueClassificationContent['whyClassify'] };

export const WhyClassifySection = ({ content }: Props) => {
  return (
    <section
      id="section-why-classify"
      aria-labelledby="heading-why-classify"
