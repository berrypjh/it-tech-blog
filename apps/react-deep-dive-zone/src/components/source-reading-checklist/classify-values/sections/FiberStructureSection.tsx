...
export const FiberStructureSection = ({ content }: Props) => {
  return (
    <section
      id="section-fiber-structure"
      aria-labelledby="heading-fiber-structure"
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,_6fr)_minmax(0,_6fr)] gap-md lg:gap-lg items-start">
        {/* LEFT — Code + field groups */}
        <div className="flex flex-col gap-md">
          <ValueBadge valueKey="fiber" size="md" strong className="self-start" />
              ...
              {content.fieldGroups.map((group) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span aria-hidden="true" className="text-[10px] text-[var(--term-dim)]">
                      →
                    </span>
