...
type Props = { content: CallPathCompressionContent['whyCompress'] };

export const WhyCompressionSection = ({ content }: Props) => {
  return (
    <section
      id="section-why-compress"
      aria-labelledby="heading-why-compress"
