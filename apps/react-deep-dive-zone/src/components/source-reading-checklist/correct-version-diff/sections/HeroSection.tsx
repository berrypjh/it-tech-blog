...
import { VersionDiffHeroDiagram } from '../components/VersionDiffHeroDiagram';
...
export const HeroSection = ({ content }: Props) => (
  <HeroShell
    promptCommand="cat"
    promptPath="source-reading-checklist/correct-version-diff.md"
    promptSuffix={
  ...
  >
    ...
    <HeroVisualColumn id="hero-correct-version-diff">
      <VersionDiffHeroDiagram content={content} />
    </HeroVisualColumn>
  </HeroShell>
);
