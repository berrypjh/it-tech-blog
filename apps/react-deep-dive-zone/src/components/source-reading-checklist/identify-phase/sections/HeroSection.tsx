...
import { IdentifyPhaseHeroDiagram } from '../components/IdentifyPhaseHeroDiagram';
...
export const HeroSection = ({ content }: Props) => (
  <HeroShell
    promptCommand="cat"
    promptPath="source-reading-checklist/identify-phase.md"
    promptSuffix={
  ...
  >
    ...
    <HeroVisualColumn id="hero-identify-phase">
      <IdentifyPhaseHeroDiagram content={content} />
    </HeroVisualColumn>
  </HeroShell>
);
