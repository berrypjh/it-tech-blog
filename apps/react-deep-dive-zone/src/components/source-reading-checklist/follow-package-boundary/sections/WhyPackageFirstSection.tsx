...
export const WhyPackageFirstSection = ({ content }: Props) => {
  return (
    <section id="section-why-package" aria-labelledby="heading-why-package" className="space-y-lg">
      <SectionHeader
        id="why-package"
          ...
          <li key={card.number}>
            ...
            >
              ...
              <div className="mt-auto pt-sm border-t border-dashed border-amber-300/70 dark:border-amber-700/60">
                <PackageBadge packageKey={card.packageHint} size="md">
                  {card.packageHint}
                </PackageBadge>
              </div>
            </article>
