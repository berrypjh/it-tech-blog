...
type Props = { content: FullFlowContent['cta'] };

export const FullFlowNextCTA = ({ content }: Props) => (
  <section aria-label="next-chapter">
    <Link
      href={content.href}
      className={cn(
    ...
    >
      ...
      <div className="relative grid grid-cols-[auto_1fr_auto] gap-3 sm:gap-md lg:gap-lg items-center">
        ...
        >
          <TrophyIcon className="h-5 w-5 sm:h-6 sm:w-6" strokeWidth={2.2} />
        </span>
