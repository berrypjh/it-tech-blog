import type { YieldAccent } from './content';

/**
 * Class tokens for 5 accents used on the pause-resume-render page.
 * - blue: workLoop / current task / Fiber processing
 * - teal: shouldYieldToHost / frame budget
 * - violet: yield / break
 * - emerald: continuation / resume / complete
 * - rose: problem / input delay
 */

export const yldCardBorder: Record<YieldAccent, string> = {
...
export const yldIconBox: Record<YieldAccent, string> = {
...
export const yldTextStrong: Record<YieldAccent, string> = {
...
export const yldNumberBadge: Record<YieldAccent, string> = {
...
export const yldPill: Record<YieldAccent, string> = {
...
export const yldBar: Record<YieldAccent, string> = {
