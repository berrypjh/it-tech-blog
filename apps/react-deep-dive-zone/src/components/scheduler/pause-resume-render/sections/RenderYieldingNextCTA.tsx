...
type Props = { content: RenderYieldingContent['cta'] };

export const RenderYieldingNextCTA = ({ content }: Props) => (
    ...
    >
      ...
      <div className="relative grid grid-cols-[auto_1fr_auto] gap-3 sm:gap-md lg:gap-lg items-center">
        ...
        <div className="flex flex-col gap-1 min-w-0">
          ...
          <p className="text-xsm sm:text-sm leading-snug text-blue-100/80 break-keep">
            {content.pretext}
          </p>
