...
export const ContinuationResumeSection = ({ content }: Props) => (
  <section aria-labelledby="heading-continuation">
            ...
            return (
              <li key={step} className="flex flex-col">
                ...
                >
                  <span
                    aria-hidden="true"
                    className="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-emerald-600 text-white text-[10px] font-mono font-bold tabular-nums dark:bg-emerald-500"
                  >
                    {i + 1}
                  </span>
                  <span
