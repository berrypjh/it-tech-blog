...
type Props = { content: SchedulerPackageContent['code'] };
    ...
    return (
      <span
        ...
        className={cn(
          ...
          tok === 'getCurrentTime' && 'text-emerald-300 font-semibold',
        )}
      >
        {tok}
      </span>
...
export const SchedulerPackageCodePreview = ({ content }: Props) => (
