...
import { schedCardBorder, schedIconBox } from '../schedulerAccent';

type Props = { content: RootSchedulerContent['mission'] };

const missionIcons = [FileSearchIcon, WorkflowIcon, CogIcon, GitForkIcon];

export const RootSchedulerMission = ({ content }: Props) => (
