...
import { ClockIcon, DatabaseIcon, FlagIcon, TrophyIcon, ZapIcon } from '../icons';

type Props = { content: RootPendingWorkContent['takeaways'] };
...
const iconWash: Record<RootAccent, string> = {
...
export const RootPendingWorkKeyTakeaways = ({ content }: Props) => (
