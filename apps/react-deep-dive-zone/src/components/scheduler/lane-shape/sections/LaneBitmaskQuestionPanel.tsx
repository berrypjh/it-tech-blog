...
export const LaneBitmaskQuestionPanel = ({ content }: Props) => (
  ...
  >
    <div className="flex flex-col gap-md lg:flex-row lg:items-center lg:gap-lg">
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-3 lg:flex lg:flex-col gap-2 lg:gap-2 lg:min-w-[250px]">
          ...
          return (
            <li
              ...
              className={cn(
                ...
                'bg-white shadow-[0_1px_0_var(--term-border)] dark:bg-slate-950/40',
