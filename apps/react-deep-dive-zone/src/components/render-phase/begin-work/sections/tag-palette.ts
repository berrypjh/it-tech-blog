import type { FiberTagAccent } from '../content';
import type { FiberTagItem } from '../content';
import {
  BoxIcon,
  CircleAlertIcon,
  CodeIcon,
...
export const tagPalette: Record<FiberTagAccent, TagPalette> = {
  teal: {
  ...
  sky: {
    ...
    borderHover: 'hover:border-sky-400/80 dark:hover:border-sky-500/70',
  },
  amber: {
  ...
  slate: {
    ...
    bg: 'bg-slate-50/60 dark:bg-slate-950/25',
    chip: 'bg-slate-100 text-slate-700 border-slate-200/80 dark:bg-slate-900/60 dark:text-slate-200 dark:border-slate-700/60',
    text: 'text-slate-700 dark:text-slate-200',
    dot: 'bg-slate-500 dark:bg-slate-400',
    borderHover: 'hover:border-slate-400/80 dark:hover:border-slate-500/70',
  },
  indigo: {
...
export const tagIconMap: Record<FiberTagItem['iconName'], typeof BoxIcon> = {
  function: FunctionSquareIcon,
  cube: BoxIcon,
  home: HomeIcon,
  code: CodeIcon,
  dashedSquare: SquareDashedIcon,
