...
import { ArrowRightIcon, CheckCircleIcon, RocketIcon, SparklesIcon } from '../icons';

type Props = {
  quiz: BeginWorkContent['quiz'];
  cta: BeginWorkContent['cta'];
};

export const BeginWorkQuizAndCTA = ({ quiz, cta }: Props) => (
  <section id="quiz-cta" aria-labelledby="heading-quiz-cta" className="space-y-md scroll-mt-xl">
    <SectionBadgeHeader
      id="quiz-cta"
      number={quiz.number}
