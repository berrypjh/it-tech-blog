...
export const WorkLoopHero = ({ content }: Props) => (
  <section aria-labelledby="hero-heading" className="relative">
    <TerminalPrompt
      command="cat"
      path="reconciler/work-loop.md"
      suffix={<span className="text-[var(--term-dim)]"> {'// sync vs concurrent'}</span>}
    />
    ...
    <div className="mt-lg grid grid-cols-1 lg:grid-cols-[minmax(0,_0.82fr)_minmax(0,_1.18fr)] gap-xl lg:gap-2xl items-start">
      ...
      <div className="flex flex-col gap-md min-w-0">
        ...
        >
          ...
          <span
            className={cn(
              'block bg-gradient-to-r from-sky-600 via-violet-500 to-teal-500 bg-clip-text text-transparent',
