...
type Props = {
  quiz: HostComponentContent['quiz'];
  cta: HostComponentContent['cta'];
};

export const HostComponentQuizAndCTA = ({ quiz, cta }: Props) => (
  <div className="flex flex-col gap-xl lg:gap-2xl">
    ...
    {/* CTA */}
    <section id="cta" aria-labelledby="heading-cta" className="scroll-mt-xl">
      <div
        className={cn(
