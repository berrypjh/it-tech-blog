...
import type { CodeCallout, HostComponentContent } from '../content';
import { CodeIcon, FileCodeIcon, HelpCircleIcon } from '../icons';

import { tonePalette } from './tone-palette';

type Props = { content: HostComponentContent['code'] };

export const HostComponentCodeCheckpoint = ({ content }: Props) => (
  <section
