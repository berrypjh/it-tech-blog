...
export const RenderPhaseHero = ({ content }: Props) => (
  <section aria-labelledby="hero-heading" className="relative">
    <TerminalPrompt
      command="cat"
      path="reconciler/render-phase.md"
      suffix={<span className="text-[var(--term-dim)]"> {'// what is the render phase?'}</span>}
    />

    <div className="mt-lg grid grid-cols-1 lg:grid-cols-[minmax(0,_0.88fr)_minmax(0,_1.12fr)] gap-xl lg:gap-2xl items-start">
      {/* Left text */}
