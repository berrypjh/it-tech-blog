...
type Props = { content: RenderPhaseIntroContent['quiz'] };

export const RenderPhaseMiniQuiz = ({ content }: Props) => (
  <section id="mini-quiz" aria-labelledby="heading-mini-quiz" className="space-y-md">
    <SectionHeader
      id="mini-quiz"
