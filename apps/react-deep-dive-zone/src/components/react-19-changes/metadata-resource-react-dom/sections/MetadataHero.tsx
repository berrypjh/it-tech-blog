...
export const MetadataHero = ({ content }: Props) => (
  <section aria-labelledby="hero-heading" className="relative">
    <TerminalPrompt
      command="cat"
      path="react-19-changes/metadata-resource-react-dom.md"
      suffix={
    ...
    <div className="mt-md grid grid-cols-1 gap-md lg:gap-lg lg:grid-cols-2 items-stretch">
      {/* LEFT: badges + heading + subtitle + code */}
