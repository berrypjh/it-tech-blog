...
import { ArrowRightIcon, ExternalLinkIcon, RotateCcwIcon, ServerIcon, TargetIcon } from '../icons';

type Props = { content: MetadataResourceContent['nextCTA'] };
  ...
  >
    ...
    <div className="relative grid grid-cols-1 gap-md lg:gap-lg lg:grid-cols-[auto_minmax(0,_1fr)_minmax(0,_320px)] items-center">
      <div className="flex justify-center lg:justify-start">
        ...
        >
          <ServerIcon className="h-8 w-8 sm:h-10 sm:w-10 text-cyan-200" />
        </span>
      </div>
