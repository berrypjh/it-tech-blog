...
type Props = { content: RefAsPropElementShapeContent['propsRefFlow'] };

export const PropsRefSourceOfTruthFlow = ({ content }: Props) => (
  <section aria-labelledby="props-ref-flow-heading" className="flex flex-col">
    <SectionHeader
      id="props-ref-flow-heading"
            ...
            <li>
              ...
              >
                ...
                {step.code && (
                  <pre
                    className={cn(
                      'overflow-x-auto rounded-lg border-2 bg-slate-950 px-2 py-1.5',
                      'border-teal-700/60',
                      'text-[11px] leading-relaxed',
                    )}
                  >
                    <code className="font-mono text-teal-300 whitespace-pre">{step.code}</code>
                  </pre>
                )}
