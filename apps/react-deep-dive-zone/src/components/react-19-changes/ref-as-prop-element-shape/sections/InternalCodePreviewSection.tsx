...
type Props = { content: RefAsPropElementShapeContent['internalCode'] };
...
export const InternalCodePreviewSection = ({ content }: Props) => (
  <section aria-labelledby="internal-code-heading" className="flex flex-col">
    ...
    <div className="grid grid-cols-1 gap-md lg:grid-cols-[minmax(0,_8fr)_minmax(0,_4fr)] lg:gap-lg items-stretch">
      {/* LEFT: wide code panel */}
      <div className="flex">
        <CodePanel
