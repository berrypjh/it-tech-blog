...
type Props = { content: FormActionsEventSystemContent['startHostTransition'] };

export const StartHostTransitionSection = ({ content }: Props) => (
  <section aria-labelledby="start-host-transition-heading" className="flex flex-col">
    <SectionHeader
      id="start-host-transition-heading"
          ...
          <Fragment key={step.title}>
            <li>
              ...
              >
                ...
                <h3 className={cn('text-sm font-bold break-keep leading-snug', tone.text)}>
                  {step.title}
                </h3>
    ...
    >
      <span
        aria-hidden="true"
        className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-md border border-blue-200 bg-blue-100 text-blue-700 dark:border-blue-800/60 dark:bg-blue-950/60 dark:text-blue-200"
      >
