...
type Props = { content: CreateFiberFromTypeAndPropsContent['next'] };
  ...
  <section id="next" aria-labelledby="heading-next" className="space-y-md scroll-mt-xl">
    ...
    <div
      className={cn(
        ...
        'dark:from-sky-950/40 dark:via-[var(--term-bg)] dark:to-emerald-950/20',
    ...
    >
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -top-6 -right-6 w-32 h-32 rounded-full bg-emerald-300/20 blur-2xl"
      />
