...
import type { FunctionClassComponentFiberContent, QuizCard } from '../content';
import { CheckCircleIcon, HelpCircleIcon } from '../icons';

type Props = { content: FunctionClassComponentFiberContent['quiz'] };
...
export const FunctionClassMiniQuiz = ({ content }: Props) => (
    ...
    >
      ...
      <div className={cn('flex items-start gap-sm rounded-xl border p-md', a.surface)}>
        ...
        <div className="flex flex-col gap-1 min-w-0">
          ...
          <code
            className={cn('font-mono text-sm sm:text-md font-extrabold break-all', a.answerText)}
          >
            {card.answer}
          </code>
        </div>
