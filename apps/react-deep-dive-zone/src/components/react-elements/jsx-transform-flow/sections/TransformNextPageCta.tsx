...
import { NextRuntimeIllustration } from '../components/NextRuntimeIllustration';
import type { JsxTransformFlowContent } from '../content';
import { ArrowRightIcon, RotateIcon } from '../icons';

type Props = { content: JsxTransformFlowContent['next'] };

export const TransformNextPageCta = ({ content }: Props) => (
    ...
    >
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-[auto_minmax(0,1fr)_auto] gap-md sm:gap-lg items-center">
        <div className="flex justify-center lg:justify-start">
          <NextRuntimeIllustration className="h-28 w-32 sm:h-32 sm:w-36" />
        </div>
