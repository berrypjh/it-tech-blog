    ...
    >
      <div className="flex items-start gap-sm">
        ...
        <div className="flex flex-col gap-1 min-w-0">
          <span
            className={cn('text-[10px] uppercase tracking-wider font-mono', toneTokens.sky.text)}
          >
            {questionLabel}
          </span>
      ...
      >
        <LetterBadge tone={card.tone}>A</LetterBadge>
        <div className="flex flex-col gap-1 min-w-0">
          <span className={cn('text-[10px] uppercase tracking-wider font-mono', t.text)}>
            {answerLabel}
          </span>
          <code
            className={cn('font-mono text-sm sm:text-md font-bold leading-snug break-all', t.text)}
          >
            {card.answer}
          </code>
        </div>
