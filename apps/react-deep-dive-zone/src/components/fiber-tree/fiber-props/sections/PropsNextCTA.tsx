...
import { ArrowRightIcon, DatabaseIcon, RocketIcon } from '../icons';

type Props = { content: FiberPropsContent['next'] };

export const PropsNextCTA = ({ content }: Props) => (
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-[auto_minmax(0,_1fr)_auto] gap-md sm:gap-lg items-center">
        <div className="flex items-center justify-center">
          <div
            className={cn(
              'relative inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-2xl',
            ...
            aria-hidden="true"
          >
            <DatabaseIcon className="h-7 w-7 sm:h-8 sm:w-8" />
          </div>
        </div>
