...
import type { FiberLanesContent, QuizCard } from '../content';
import { CheckCircleIcon, HelpCircleIcon } from '../icons';

type Props = { content: FiberLanesContent['quiz'] };
...
export const LanesMiniQuiz = ({ content }: Props) => (
...
const QuizCardItem = ({
  ...
  return (
    ...
    >
      ...
      <div className={cn('flex items-start gap-sm rounded-2xl border-2 p-md mt-auto', t.answerBox)}>
        <span
          aria-hidden="true"
          className={cn(
