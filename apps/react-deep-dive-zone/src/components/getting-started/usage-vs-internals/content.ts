  ...
  ko: {
    ...
    sourceCode: {
      ...
      cards: [
        {
          num: '1',
          title: 'ReactFiberHooks.js / dispatchSetState',
          description: '상태 업데이트의 시작점',
          code: dispatchCode,
          href: `${githubBase}/ReactFiberHooks.js#L3598`,
          linkLabel: 'GitHub에서 보기',
        },
        {
          num: '2',
          title: 'ReactFiberWorkLoop.js / scheduleUpdateOnFiber',
          description: '스케줄링을 시작하고 루트 작업을 예약',
          code: scheduleCode,
          href: `${githubBase}/ReactFiberWorkLoop.js#L973`,
          linkLabel: 'GitHub에서 보기',
        },
      ],
    },
