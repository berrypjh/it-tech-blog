...
export const CodeCheckpointSection = ({ content }: Props) => {
  const t = toneTokens[content.callout.tone];
  return (
        ...
        <div className="flex flex-col gap-md min-w-0">
          ...
          >
            <span
              aria-hidden="true"
              className={cn(
                'inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full border font-mono font-bold',
                t.chip,
              )}
            >
              ⚡
            ...
            <div className="flex flex-col gap-1 min-w-0">
              ...
              >
                line {content.callout.linkedLine}
              </span>
            </div>
          </article>
