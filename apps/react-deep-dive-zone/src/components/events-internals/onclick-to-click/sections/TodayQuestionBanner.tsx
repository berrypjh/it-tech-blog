...
import { ArrowRightLeftIcon, HelpCircleIcon, PuzzleIcon, TargetIcon } from '../icons';

type Props = { content: OnClickClickContent['question'] };
...
const badgeIcons = [ArrowRightLeftIcon, PuzzleIcon, TargetIcon];
...
export const TodayQuestionBanner = ({ content }: Props) => (
  ...
  >
    <div className="flex flex-col gap-md lg:flex-row lg:items-center lg:gap-lg">
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-3 lg:flex lg:flex-col gap-2 lg:min-w-[240px]">
