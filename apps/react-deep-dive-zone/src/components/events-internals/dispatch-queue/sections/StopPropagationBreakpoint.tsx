...
const toneCard: Record<Tone, string> = {
  ...
  rose: 'border-rose-400/90 bg-gradient-to-br from-rose-50 to-amber-50 dark:border-rose-700/70 dark:from-rose-950/40 dark:to-amber-950/20',
};
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span
                aria-hidden="true"
                className={cn(
                  'inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-lg border bg-white dark:bg-slate-950/40',
