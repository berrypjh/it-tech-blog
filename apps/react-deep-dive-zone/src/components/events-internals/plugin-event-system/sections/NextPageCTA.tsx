...
type Props = { content: PluginEventSystemContent['cta'] };
...
export const NextPageCTA = ({ content }: Props) => (
  ...
  >
    ...
    <div className="relative flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-md sm:px-lg py-md sm:py-lg text-center">
      <span
        aria-hidden="true"
        className="inline-flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-white/15 text-white"
      >
