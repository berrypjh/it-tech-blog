...
export const toneCard: Record<Tone, string> = {
  ...
  mint: 'border-emerald-300/80 bg-gradient-to-br from-emerald-50/70 to-teal-50/40 dark:border-emerald-700/70 dark:from-emerald-950/30 dark:to-teal-950/20',
};

export const toneNumber: Record<Tone, string> = {
  ...
  mint: 'bg-emerald-500 text-white dark:bg-emerald-400 dark:text-slate-900',
};
...
export const toneIconBox: Record<Tone, string> = {
  ...
  mint: 'bg-emerald-100 text-emerald-700 border-emerald-200 dark:bg-emerald-950/60 dark:text-emerald-200 dark:border-emerald-800/60',
};
...
export const toneBadge: Record<Tone, string> = {
  ...
  mint: 'border-emerald-300/80 bg-white text-emerald-700 dark:border-emerald-700/70 dark:bg-slate-950/40 dark:text-emerald-200',
};
