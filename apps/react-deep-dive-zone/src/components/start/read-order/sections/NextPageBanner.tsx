...
const OpenBookDecoration = () => (
  ...
  >
    ...
    >
      <defs>
        <pattern id="next-ro-grid" x="0" y="0" width="14" height="14" patternUnits="userSpaceOnUse">
          <path
            d="M14 0H0v14"
            fill="none"
            stroke="currentColor"
