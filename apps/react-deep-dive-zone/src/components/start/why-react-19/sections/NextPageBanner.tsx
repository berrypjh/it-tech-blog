  ...
  >
    ...
    >
      <defs>
        ...
        <linearGradient id="navy-page-grad" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="currentColor" className="text-sky-700" />
          <stop offset="1" stopColor="currentColor" className="text-teal-600" />
        </linearGradient>
      </defs>
      <rect width="200" height="140" fill="url(#next-navy-grid)" />

      {/* 열린 책 */}
      <g transform="translate(40, 30)">
        <path
          d="M0 70 L0 14 Q60 -6 60 14 L60 70 Q30 56 0 70 Z"
          fill="url(#navy-page-grad)"
          stroke="currentColor"
          strokeWidth="1.2"
...
export const NextPageBanner = ({ content }: Props) => {
  return (
    <section id="section-next" aria-labelledby="heading-next" className="space-y-md">
      ...
      <Link
        href={content.href}
        className="group block rounded-lg border border-slate-800 bg-gradient-to-br from-slate-900 via-slate-950 to-sky-950 text-white p-md sm:p-lg lg:p-xl shadow-[0_4px_0_var(--term-border)] overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--term-bg)] transition-all hover:shadow-[0_6px_0_var(--term-border)]"
      >
        <div className="relative">
          {/* 배경 spark */}
          <span aria-hidden="true" className="absolute right-2 top-2 text-teal-300/60">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,_0.42fr)_minmax(0,_1fr)_auto] gap-md lg:gap-lg items-center">
            ...
            <span className="inline-flex items-center justify-center gap-2 px-lg py-3 rounded-md bg-teal-400 text-slate-900 text-xsm font-bold transition-transform group-hover:translate-x-0.5 self-stretch lg:self-auto shadow-[0_2px_0_var(--term-border)]">
              {content.cta}
