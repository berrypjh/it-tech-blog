...
import { ArrowRightIcon, CheckCircleIcon, RefreshIcon, RocketIcon, SparklesIcon } from '../icons';

type Props = {
  quiz: DeletionContent['quiz'];
  cta: DeletionContent['cta'];
};

export const DeletionQuizAndNextSection = ({ quiz, cta }: Props) => (
