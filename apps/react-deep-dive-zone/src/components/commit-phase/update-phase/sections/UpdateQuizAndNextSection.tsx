...
type Props = {
  quiz: UpdatePhaseContent['quiz'];
  cta: UpdatePhaseContent['cta'];
};

export const UpdateQuizAndNextSection = ({ quiz, cta }: Props) => (
  <section id="quiz-and-next" className="space-y-md scroll-mt-xl">
    ...
    <div
      className={cn(
        ...
        'bg-gradient-to-br from-sky-50/80 via-white to-rose-50/40',
        'dark:from-sky-950/40 dark:via-[var(--term-bg)] dark:to-rose-950/30',
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="pointer-events-none absolute bottom-0 right-1/4 h-24 w-24 rounded-full bg-rose-200/40 blur-3xl dark:bg-rose-500/10"
      />
